# covid_spend_state_wkbk.py
# Created by Sam Delfino
# Collect Data for COVID Reimbursement
import warnings
...
df = lake.get_df("covid_spend_state_wkbk", "PL_COVID_SPEND_STATE_WORKBOOK", datestring)
...
for db_name in db_names:
    ...
    for row in df.itertuples():
        ...
        db.LAST_UPDATED.update({'dbname': 'PL_COVID_SPEND_STATE_WORKBOOK'}, {
